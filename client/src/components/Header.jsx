...
function Header() {
  return (
    <div className=" w-[100%] shadow-sm shadow-blue-400 py-3 sm:px-0 px-5">
      <header className="  max-w-7xl mx-auto flex justify-between items-center">
        <div className=" text-3xl text-blue-400 font-extrabold flex  items-baseline">
          𝕏
        ...
        <div className=" flex justify-center items-end w-[100%]">
          <section className=" sm:w-[60%] w-[80%]  border border-blue-400 flex items-center rounded-full  overflow-hidden  py-2">
            {" "}
            <input
              type="text"
              className="  flex-grow py-2 w-[100%] outline-none px-5"
            />{" "}
            <button className="  bg-blue-400  sm:mr-2 mr-3 px-5 sm:py-1 py-2 rounded-full  cursor-pointer text-white">
              <Search />
            </button>
          </section>
        </div>
        ...
        <nav className=" sm:flex items-center text-sm gap-3 font-bold hidden">
          <NavLink
            ...
            <p className="  hover:border-b  border-blue-400  cursor-pointer">
              Home
            </p>
          </NavLink>
          <NavLink
