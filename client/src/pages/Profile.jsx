    ...
    <div className=" max-w-full mx-auto">
      ...
      <form className=" flex flex-col gap-5">
        ...
        <input
          ...
          className=" rounded-full border border-blue-500 border-solid p-3 sm:w-[60%]  w-[80%] shadow-md shadow-gray-400 outline-none mx-auto"
        />
        <input
          id="email"
          type="email"
      ...
      <div className=" max-w-lg mx-auto flex justify-between mt-5">
